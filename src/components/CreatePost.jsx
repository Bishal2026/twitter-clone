    ...
    <div className="w-[100%] ">
      <div>
        <div className="flex  justify-evenly items-center border-b border-red-300">
          <div className="cursor-pointer hover:bg-gray-200 text-center w-full ">
            <h2 className=" font-semibold text-lg text-gray-800 mx-8 my-4 ">
              For you
            </h2>
          </div>

          <div className="cursor-pointer w-full hover:bg-gray-200 ">
            <h2 className=" font-semibold text-lg text-gray-800 mx-8 my-4 ">
              Following
            </h2>
          </div>
      ...
      <div className="border-b border-red-300 ">
        ...
        <div className="p-2 flex items-center justify-between">
          ...
          <button className="px-3 py-1 border-none bg-[#1D9BF0] text-md text-white rounded-full  font-bold">
            Post
          </button>
        </div>
      </div>
